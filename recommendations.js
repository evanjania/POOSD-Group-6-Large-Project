...
/* Add recommendation
Pre: Request contains, username, title, category, rating as strings and notes are optional
...
router.post('/add', async (req, res) => {
    try{
        ...
        if(!username || !title || !category || !rating){
